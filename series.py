...
#     getTension = lambda self,V,calibrTension,TV: V*220/calibrTension*TV
#     getFlicker = lambda self,flickerRaw,calibrFlicker,V,TV: ((flickerRaw*220*.02)/calibrFlicker)*(100/V*TV)
#     getThd = lambda self,V,thdRaw,calibrResiduo,calibrTension,vRaw,calibrThd,TV: (100/V*TV)*(abs(thdRaw-((calibrResiduo/calibrTension)*vRaw)))*18/calibrThd
...
class serieViejaTrifasica:
    ...
    unpackHeaderCalibracion = {'string':'HHHHHHHH','indices':[2,3,4,5,6]}
    unpackErr = '>BBBBBBB'
...
class serie1104Trifasica:
    ...
    getEnergia = lambda self,j,k,l: ((((j<<7)+k)<<7)+l)*0.015687283128499985/1000
    getCosPhi = lambda self,energia,I,V,periodo,TV,TI: energia/(I*V*TV*TI/1000*periodo/60)
    getTension = lambda self,V,calibrTension: V*0.008392463438212872
    getCorriente = lambda self,I,TI: I*0.005086340010166168*TI*35/35
    getFlicker = lambda self,flickerRaw,calibrFlicker,V,TV: ((flickerRaw*220*.02)/calibrFlicker)*(100/V*TV)
    getThd = lambda self,V,thdRaw,calibrResiduo,calibrTension,calibrThd,TV: (100/V*TV)*((18/(calibrThd-calibrResiduo))*(thdRaw-(V*TV*int(calibrResiduo/calibrTension))))
